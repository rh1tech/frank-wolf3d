/*
 * ID_VH.C - Video Hardware helpers for RP2350
 *
 * Replaces SDL-dependent VH functions with direct framebuffer operations.
 */
...
static const uint32_t rndmasks[] = {
    0x00012000, 0x00020400, 0x00040023, 0x00090000,
    0x00140000, 0x00300000, 0x00420000, 0x00e10000,
    0x01200000,
};
